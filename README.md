...
Run OpenClaw natively on Termux (Android · aarch64) — no proot, no root, no battery drain.
...
or via curl:
curl -fsSL https://raw.githubusercontent.com/therealfreddied/openclaw-termux-native/refs/heads/main/uninstall.sh | bash
 ...
 * claude-code-termux-native — Claude Code
 * antigravity-cli-termux-native — Google Antigravity
 * grok-cli-termux-native — xAI Grok Build
 * opencode-termux-native — OpenCode
 * openclaw-termux-native — OpenClaw
 * copilot-cli-termux-native — GitHub Copilot
Notes
